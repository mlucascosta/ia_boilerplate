...
Use this directory as the active workflow memory for non-trivial work.

## Rules

1. `STATE.md` is the current source of truth for active work.
2. `ROADMAP.md` is required when work is phased.
3. `research/` stores contextual investigation.
