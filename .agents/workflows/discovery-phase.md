...
See .agents/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using .agents/templates/discovery.md structure:
...
1. **Scope the discovery** using .agents/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from .agents/templates/discovery.md
...
Use .agents/templates/discovery.md.
