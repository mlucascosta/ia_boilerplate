...
```bash
INIT=$(node ".agents/bin/gsd-tools.cjs" init manager)
...
Steps:
1. Read the plan-phase workflow: cat .agents/workflows/plan-phase.md
2. Run: node \".agents/bin/gsd-tools.cjs\" init plan-phase {N}
...
Steps:
1. Read the execute-phase workflow: cat .agents/workflows/execute-phase.md
2. Run: node \".agents/bin/gsd-tools.cjs\" init execute-phase {N}
