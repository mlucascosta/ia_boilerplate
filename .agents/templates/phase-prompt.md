...
<!-- For checkpoint task examples and patterns, see @.agents/references/checkpoints.md -->
...
See `.agents/templates/user-setup.md` for full schema and examples
...
See `.agents/workflows/verify-phase.md` for verification logic.
