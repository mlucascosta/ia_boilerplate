...
Use template from `.agents/templates/UI-SPEC.md`.
...
Read template: `.agents/templates/UI-SPEC.md`
...
```bash
node ".agents/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
