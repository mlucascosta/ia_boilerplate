...
**Project instructions:** Read `.agents/AGENTS.md` first. Then read `./CLAUDE.md` if it exists in the working directory. Follow all project-specific guidelines.

**Project skills:** Check `.agents/skills/` first, then `.claude/skills/` if a runtime-specific overlay exists:
1. List available skills (subdirectories)
2. Read `SKILL.md` for each skill
3. Do NOT load large repository AGENTS files beyond `.agents/AGENTS.md`
</project_context>
