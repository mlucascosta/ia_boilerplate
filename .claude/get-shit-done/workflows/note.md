...
- **Global scope**: `/Users/mlucascosta/Documents/dev/reduto/collabPix/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/mlucascosta/Documents/dev/reduto/collabPix/.claude/notes/`)
...
2. Glob `/Users/mlucascosta/Documents/dev/reduto/collabPix/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/mlucascosta/Documents/dev/reduto/collabPix/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/mlucascosta/Documents/dev/reduto/collabPix/.claude/notes/` — works in any directory
